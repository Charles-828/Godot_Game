...
onready var chat_display = $UILayer/Control/ChatDisplay
...
func _ready():
	...
	GameSystem.send_msg("唱、跳、rap、篮球、music！")
...
func show_create_host_dialog():
	...
	create_host_dialog.player_name.text = "纯路人"
	create_host_dialog.popup_centered()


func show_connect_to_host_dialog():
	connect_to_host_dialog.player_name.text = "小黑子"
...
func _on_ChatDisplay_command_entered(cmd):
